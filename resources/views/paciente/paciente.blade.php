...
<nav class="cm-navbar cm-navbar-primary">
    ...
    <div class="cm-flex">
        <h1>Paciente</h1> 
        <form id="cm-search" action="{{url('paciente/lista')}}" method="get">
            <input type="search" name="s" autocomplete="off" placeholder="Buscar paciente por nome ou cpf...">
        </form>
    </div>
...
<script type="text/javascript" src="{{url('js/paciente.js')}}"></script>
<script type="text/javascript" src="{{url('js/ng-filters-br.min.js')}}"></script>
@endsection
@section('content')
    <div style="margin-top: 4%" ng-app="paciente">
	   @yield('sub-content')
    </div>
@endsection
